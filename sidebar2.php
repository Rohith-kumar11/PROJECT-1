...
<div class="sidebar">
    ...
    <ul class="sidebar-menu">
        <li class="menu-item">
            <a href="entrepreneur-dashboard.php" class="menu-link <?php echo $current_page === 'entrepreneur-dashboard.php' ? 'active' : ''; ?>">
                <i class="fas fa-chart-line"></i>
                Dashboard
            </a>
        </li>
        <li class="menu-item">
            <a href="entrepreneur-profile.php" class="menu-link <?php echo $current_page === 'entrepreneur-profile.php' ? 'active' : ''; ?>">
